...
the primary cause
 of everything`,author:"Rhonda Byrne"}];function z(a){let o,s,i,m,r,c,d,e,g,p;return{c(){o=v("section"),s=v("div"),i=B(a[0]),m=R(),r=v("div"),c=B(a[0]),d=R(),e=v("textarea"),this.h()},l(n){o=q(n,"SECTION",{class:!0});var t=w(o);s=q(t,"DIV",{id:!0,class:!0,style:!0});var h=w(s);i=x(h,a[0]),h.forEach(f),m=S(t),r=q(t,"DIV",{id:!0,class:!0,style:!0});var l=w(r);c=x(l,a[0]),l.forEach(f),d=S(t),e=q(t,"TEXTAREA",{class:!0,spellcheck:!0,maxlength:!0}),w(e).forEach(f),t.forEach(f),this.h()},h(){u(s,"id","shadow1"),u(s,"class","shadow svelte-uo3taq"),u(s,"style",a[2]),u(r,"id","shadow2"),u(r,"class","shadow svelte-uo3taq"),u(r,"style",a[3]),u(e,"class","text svelte-uo3taq"),u(e,"spellcheck","false"),u(e,"maxlength","128"),e.disabled=a[1],u(o,"class","svelte-uo3taq")},m(n,t){Y(n,o,t),y(o,s),y(s,i),y(o,m),y(o,r),y(r,c),y(o,d),y(o,e),C(e,a[0]),g||(p=[E(e,"input",a[5]),E(e,"dblclick",a[4])],g=!0)},p(n,[t]){t&1&&D(i,n[0]),t&1&&D(c,n[0]),t&2&&(e.disabled=n[1]),t&1&&C(e,n[0])},i:k,o:k,d(n){n&&f(o),g=!1,P(p)}}}const T=800,b=1;function F(a,o,s){const i=Math.PI/180*118,m=Math.cos(i),r=Math.sin(i),c=Math.floor(Math.random()*_.length);let d=_[c].quote;_[c].author;const e="text-shadow:"+Array(T).fill("").map((h,l)=>`${m*l/b}px ${r*l/b}px 0px #292929`).join(","),g="text-shadow:"+Array(T).fill("").map((h,l)=>`${m*l/b}px ${r*l/b}px 0px #342c40`).join(",");let p=!1;function n(){s(1,p=!p);const h=document.getElementsByTagName("textarea")[0];h.setSelectionRange(h.value.length,h.value.length)}function t(){d=this.value,s(0,d)}return[d,p,e,g,n,t]}class N extends j{constructor(o){super(),A(this,o,F,z,M,{})}}export{N as component,L as universal};
